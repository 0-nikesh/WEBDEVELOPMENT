...
function CartItem(props: Props) {
  return (
    <div className='shadow-lg bg-white px-8 py-4 max-w-3xl mx-auto flex items-center justify-between mb-8 rounded-lg'>
    <img
    ...
    <div>
      ...
      <p className='text-sm'>{props.item.product.description}</p> 
    </div>
    <div>
      <button
        className='font-bold'
      ...
      >
        <AiFillMinusCircle size={20} color='blue' />
      </button>
    </div>
  </div>
