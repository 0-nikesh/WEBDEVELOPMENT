    ...
    <header className='container flex justify-between py-2 items-center'>
      ...
      <nav className='hidden md:flex'>
        <ul className='flex items-center gap-4 text-xl'>
          ...
          <li className='cursor-pointer'>
            <NavLink to='/products/tshirt'> T-shirt </NavLink>
          </li>
          <li className='cursor-pointer'>
            <NavLink to='/products/polo'>Polo</NavLink>
          </li>
          <li className='cursor-pointer'>
            <NavLink to='/products/sweatshirt'> Sweatshirt  </NavLink>
          </li>
          <li className='cursor-pointer'>
      ...
      <nav
        className={`flex justify-center items-center md:hidden fixed inset-0 bg-blue-100 bg-opacity-100 z-10  ${
      ...
      >
        <ul className='flex flex-col items-center gap-4 text-2xl'>
          ...
          <li className='cursor-pointer'>
            <NavLink to='/products/tshirt'> Tshirt </NavLink>
          </li>
          <li className='cursor-pointer'>
            <NavLink to='/products/polo'> Polo  </NavLink>
          </li>
        ...
        <div className='mr-4'>
          {userContext?.isAuth ? (
            userContext.role === "ROLE_ADMIN" ? (
              <div
                className='bg-white text-black rounded-md px-4 py-2 flex items-center gap-2 cursor-pointer'
                onClick={() => {
                  navigate("/admin");
                }}
              >
